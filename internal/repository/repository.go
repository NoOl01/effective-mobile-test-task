...
type Repository interface {
	...
	SubscriptionsSum(ctx context.Context, startDate, endDate time.Time, userId, serviceName string) (int, error)
	SubscriptionByUserId(ctx context.Context, userId string) ([]dto.Subscription, error)
